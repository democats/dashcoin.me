...
Webflow.require('ix').init([
  {"slug":"display-login","name":"Display-login","value":{"style":{},"triggers":[{"type":"click","selector":".modal-background","stepsA":[{"display":"block"}],"stepsB":[]}]}},
  {"slug":"close-overlay","name":"Close overlay","value":{"style":{},"triggers":[{"type":"click","selector":".modal-background","stepsA":[{"display":"none"}],"stepsB":[]}]}},
  {"slug":"display-login-key-review","name":"Display Login Key Review","value":{"style":{},"triggers":[{"type":"click","selector":".review-details-modal","stepsA":[{"display":"block"}],"stepsB":[]}]}},
  {"slug":"display-review-account","name":"Display Review Account","value":{"style":{},"triggers":[{"type":"click","selector":".review-account-details","stepsA":[{"display":"block"}],"stepsB":[]}]}},
  {"slug":"close-login-key","name":"Close-Login-Key","value":{"style":{},"triggers":[{"type":"click","selector":".review-details-modal","stepsA":[{"display":"none"}],"stepsB":[]}]}},
  {"slug":"close-review-details","name":"Close-Review-Details","value":{"style":{},"triggers":[{"type":"click","selector":".review-account-details","stepsA":[{"display":"none"}],"stepsB":[]}]}}
]);